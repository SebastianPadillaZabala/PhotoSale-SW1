...
<section class="min-h-screen flex justify-center items-center py-20">
    <div class="container px-6 py-10 mx-auto">
        <div class="text-center">
            <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Mis Eventos</h1>
        </div>
        <div class="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div class="transform hover:scale-105 transition duration-500 hover:bg-gray-50">
                ...
                <a href="{{route('allFoto', [$e->id_evento])}}">
                    <button class="mt-4 text-xl w-20 text-white bg-green-500 hover:bg-green-600 py-2 rounded-xl shadow-lg">Ver</button>
                </a>
            </div>
            @endforeach
        </div>
