  ...
  <body class="bg-white">
    <div class="m-4">
      <div class="credit-card w-full sm:w-auto shadow-lg mx-auto rounded-xl bg-white" x-data="creditCard">
        ...
        <form method="POST"  action="{{route('checkout-input',[$id])}}">
          @csrf
        <main class="mt-4 p-4">
        ...
        <footer class="mt-6 p-4">
          <button
            class="submit-button px-4 py-3 rounded-full bg-green-500 text-blue-900 focus:ring focus:outline-none w-full text-xl font-semibold transition-colors"
